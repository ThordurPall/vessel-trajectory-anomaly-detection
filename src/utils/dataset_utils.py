...
def convertShipTypeToLabel(shipType):
    ...
    #There are many other types for instance Dive Vessel, Dredgers ect. These all are added to others. Se here for full list of types https://help.marinetraffic.com/hc/en-us/articles/205579997-What-is-the-significance-of-the-AIS-Shiptype-number-    
...
class AISDataset(torch.utils.data.Dataset):
    def __init__(self, infoPath, train_mean = None):
        ...
        self.temporalMask = torch.arange(self.maxLength, device= 'cpu')[:, None] < self.lengths[None, :] #max_seq_len X len(dataset)
