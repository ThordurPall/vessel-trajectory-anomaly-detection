...
def test_reconstruction_Skagen_06():
    ...
    visualise_trajectories.plot_single_track(
        ...
        rect=[0.125, 0.65, 0.3, 0.23],
        # rect2=[0.575, 0.72, 0.12, 0.12],
        file_name="Skagen_Diagonal_Fishing_Vessel_Test_Set_Reconstruction_Worst_06_1_1",
        font_size=37,
    )
    visualise_trajectories.trajectories_fig_dir = tmp
    plt.clf()
    ...
    visualise_trajectories.plot_single_track(
        ...
        # rect=[0.125, 0.65, 0.3, 0.23],
        rect2=[0.125, 0.65, 0.3, 0.23],
        file_name="Skagen_Diagonal_Fishing_Vessel_Test_Set_Reconstruction_Worst_06_1_2",
        font_size=37,
    )
    visualise_trajectories.trajectories_fig_dir = tmp
    print(
    ...
    visualise_trajectories.plot_single_track(
        ...
        rect=[0.125, 0.65, 0.3, 0.23],
        # rect2=[0.575, 0.72, 0.12, 0.12],
        file_name="Skagen_Diagonal_Fishing_Vessel_Test_Set_Reconstruction_Worst_06_5_1",
        font_size=37,
    )
    visualise_trajectories.trajectories_fig_dir = tmp
    plt.clf()
    ...
    visualise_trajectories.plot_single_track(
        ...
        # rect=[0.125, 0.65, 0.3, 0.23],
        rect2=[0.125, 0.65, 0.3, 0.23],
        file_name="Skagen_Diagonal_Fishing_Vessel_Test_Set_Reconstruction_Worst_06_5_2",
        font_size=37,
    )
    visualise_trajectories.trajectories_fig_dir = tmp
    print(
